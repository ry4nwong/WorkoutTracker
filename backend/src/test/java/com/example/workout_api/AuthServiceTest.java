...
public class AuthServiceTest {
    ...
    void testCreateUser() throws Exception {
        when(userRepository.save(new User(registrationRequest))).thenReturn(user);
        when(userRepository.existsByUsername("testuser")).thenReturn(false);
        when(userRepository.existsByEmail("test@test.com")).thenReturn(false);

        User createdUser = authService.createUser(registrationRequest);
    ...
    void testCreateUserInvalidUsername() throws Exception {
        ...
        assertThrows(UsernameAlreadyExistsException.class, () -> authService.createUser(registrationRequest));
    ...
    void testCreateUserInvalidEmail() throws Exception {
        ...
        assertThrows(EmailAlreadyExistsException.class, () -> authService.createUser(registrationRequest));
        verify(userRepository, never()).save(any(User.class));
    }
